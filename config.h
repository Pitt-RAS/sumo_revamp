...
//Encoder Pins
#define FL_ENCODERB_PIN 15
#define FL_ENCODERA_PIN 14
#define BR_ENCODERA_PIN 26
#define FR_ENCODERB_PIN 27
#define BL_ENCODERA_PIN 29
#define BL_ENCODERB_PIN 28
...
#define BATTERY_VOLTAGE_WARNING 7.5 * (7.7 / 6.7) //When this was set to 7.7 it actually gave a warning at 6.7
#define BATTERY_VOLTAGE_DIVIDER_RATIO (10.0/(10.0+20.0)) // Vdd -- 20K -- VBat -- 10K -- GND
#define BATTERY_VOLTAGE_WARNING_COUNT 781 //(BATTERY_VOLTAGE_WARNING * (1023.0/3.3) * BATTERY_VOLTAGE_DIVIDER_RATIO)
